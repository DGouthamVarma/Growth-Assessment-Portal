...
<head>
	...
	<link rel="stylesheet" type="text/css" href="cfmentor.css">
...
<body>
	<div class="header">
		...
		<input type="text" onkeyup="searchData()" name="search" placeholder="Search for trainee" class="search">
		</form>
		...
		<div class="profile-div">
			...
			<h3 style="color:#ffffff">${sessionScope.currentMentor}</h3>
		</div>
	 ...
	 <div id="trainees-div" style="display: block;">
		...
		<h3><a target="_blank" href="cfrating?teamid=<%=(String)session.getAttribute("TeamID"+Integer.toString(i))%>">Give Rating</a></h3>
		<div id="trainees-list" style="display:block">
	...
	/* function searchData(str) {
		  if (str.length==0) { 
		    ...
		    document.getElementById("searchlocation").style.border="0px";
		    return;
		  }
		  if (window.XMLHttpRequest) {
		  ...
		  xmlhttp.onreadystatechange=function() {
		    if (this.readyState==4 && this.status==200) {
		      document.getElementById("searchlocation").innerHTML=this.responseText;
		      document.getElementById("searchlocation").style.border="1px solid #A5ACB2";
		    }
		  }
		  xmlhttp.open("GET","search.jsp?text="+str,true);
		  xmlhttp.send();
		} */
		$(function(){
